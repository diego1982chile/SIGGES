...
VALUES ( 
 ...
 'Creación de definición package VAL.VAL_PCK_VALORIZA',  
  SYSDATE, 
  'SIGG-ME578'); 
  ...
  IS
    ...
    exception
        ...
        when revalps_existente then
            ...
            v_msgora  := '.';
            v_codlog  := 1008;
            v_dsc_log := 'revalps existente para familia de glosa '||dsc_famrama||' y código de prestación '||cod_pres||'. Se hará rollback';
            raise;
