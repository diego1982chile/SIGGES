  ...
  t_name in varchar2
    ...
    begin
        ...
        while (v_cnt < v_length)
            ...
            if(v_token1='1' or v_token1='2' or v_token1='3' or v_token1='4' or v_token1='5' or v_token1='6' or v_token1='7' or v_token1='8' or v_token1='9') then
                 v_flag_num1:=true;
             end if;
                 
            if(v_token2='0' or v_token2='1' or v_token2='2' or v_token2='3' or v_token2='4' or v_token2='5' or v_token2='6' or v_token2='7' or v_token2='8' or v_token2='9') then
                 v_flag_num2:=true;
            end if;
...
BEGIN
    ...
    if(p_name = 'NCAT.NCAT_SEQ_FAMILIA_AUGE') then
        ...
        EXECUTE IMMEDIATE 'SELECT MAX('||split(t_Name)||'_COD_'||split(t_Name)||')+1  from  '||t_Name||' ' INTO p_val;
        --DBMS_OUTPUT.Put_Line( 'SELECT '||p_Name||'.NEXTVAL FROM DUAL');
        EXECUTE IMMEDIATE 'SELECT '||p_Name||'.NEXTVAL FROM DUAL' INTO v_num;
