...
VALUES ( 
 'Diego Soto', 
 '(001) [AT.NCAT] DS MD DROP_OBJETOS_BD', 
...
DECLARE
v_nomproc VARCHAR2(255):='Creación Objetos BD User NCAT: SIGGME-578, SIGGME-579, SIGGME-580, SIGGME-582, SIGGME-583';
v_codora NUMBER;
v_codlog NUMBER;
...
BEGIN	
	EXECUTE IMMEDIATE 'DROP SEQUENCE NCAT.NCAT_SEQ_FAMILIA_AUGE';
	EXECUTE IMMEDIATE 'DROP PACKAGE NCAT.NCAT_PCK_UNION';
