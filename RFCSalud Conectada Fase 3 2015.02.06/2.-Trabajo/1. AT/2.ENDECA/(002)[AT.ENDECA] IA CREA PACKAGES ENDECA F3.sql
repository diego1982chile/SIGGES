INSERT INTO sis.SIS_TAB_CONTROL_SCRIPT (RESPONSABLE,
     ...
     VALUES ('Iván Aguilera',
             '(002)[AT.ENDECA] IA CREA PACKAGES ENDECA F3.sql',
             'Crea PACKAGES ENDECA Fase 3',
             SYSDATE,
             'ENDECA FASE 3');
COMMIT;             
--------------------------------------------------------------------------------

-- DROP es redundante ya que se utiliza la instrucción a create or replace
--DROP PACKAGE ENDECA.ENDECA_PCK_FORMULARIO;

CREATE OR REPLACE PACKAGE ENDECA.ENDECA_PCK_FORMULARIO AS
/******************************************************************************
...
END ENDECA_PCK_FORMULARIO;
/

-- DROP es redundante ya que se utiliza la instrucción a create or replace
--DROP PACKAGE BODY ENDECA.ENDECA_PCK_FORMULARIO;

CREATE OR REPLACE PACKAGE BODY ENDECA.ENDECA_PCK_FORMULARIO
AS
   /******************************************************************************
      NAME:       ENDECA_PCK_FORMULARIO
      PURPOSE:
      ...
      Ver        Date        Author           Description
      ---------  ----------  ---------------  ------------------------------------
      1.0        23-12-2014      Iván       1. Created this package body.
      2.0        06-02-2015   Diego         2. Se agrega validación en el filtro para fecha otorgamiento de los formularios desde 01/07/2005 
   ******************************************************************************/
