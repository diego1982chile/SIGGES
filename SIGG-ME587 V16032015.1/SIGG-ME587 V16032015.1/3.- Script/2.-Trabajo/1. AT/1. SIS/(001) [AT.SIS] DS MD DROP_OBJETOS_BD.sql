...
BEGIN	
	...
	EXECUTE IMMEDIATE 'DROP SEQUENCE SIS.SIS_SEQ_EVEGAROPAT';
	EXECUTE IMMEDIATE 'DROP SEQUENCE SIS.SIS_SEQ_EVEGAROPAR';
	EXECUTE IMMEDIATE 'DROP PACKAGE SIS.SIS_PCK_HELPER';
	EXECUTE IMMEDIATE 'DROP PACKAGE SIS.SIS_PCK_PRESTACION';
	EXECUTE IMMEDIATE 'DROP PACKAGE SIS.SIS_PCK_EVEGAROPAT';
