...
GRANT SELECT ON VAL.VAL_TAB_VALORIZA TO SIS, NCAT;
GRANT SELECT ON VAL.VAL_TAB_REVALPREST TO SIS, NCAT;
GRANT SELECT ON VAL.VAL_TAB_REVALPS TO SIS, NCAT;

GRANT ALL ON VAL.VAL_SEQ_VALORIZA TO SIS, NCAT;
GRANT ALL ON VAL.VAL_SEQ_REVALPREST TO SIS, NCAT;
GRANT ALL ON VAL.VAL_SEQ_REVALPS TO SIS, NCAT;
